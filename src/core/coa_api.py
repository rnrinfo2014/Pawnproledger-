...
from src.core.models import MasterAccount, Company
...
async def initialize_pawn_coa(
    ...
    pawn_accounts = [
        ...
        {"account_name": "Customer Discount", "account_code": "5008", "account_type": "Expense", "group_name": "Operating Expenses", "parent_code": "5000"}
    ]
